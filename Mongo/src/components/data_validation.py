...
class DataValidation:
    def __init__(self, data_ingestion_artefact : DataIngestionArtifact, data_validation_config : DataValidationConfig):
        try:
    ...
    def read_data(file_path: str) -> DataFrame:
        ...
        Description :   This method reads the data from the file path
        
        Output      :   Returns dataframe read from the file path
        On Failure  :   Write an exception log and then raise an exception
        """
        try:
