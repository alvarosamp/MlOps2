...
Ele foi feito especificamente para classes que são basicamente 
contêineres de dados – ou seja, classes cujo propósito principal 
é armazenar e agrupar informações, com pouca ou nenhuma 
lógica de negócio.
'''
@dataclass
